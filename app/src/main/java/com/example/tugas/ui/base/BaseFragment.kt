...
import com.example.tugas.di.component.DaggerFragmentComponent
...
abstract class BaseFragment<VM : BaseViewModel, B : ViewBinding> : Fragment() {
    ...
    private fun buildFragmentComponent() =
        DaggerFragmentComponent
            .builder()
            .applicationComponent((requireContext().applicationContext as TaxApplication).applicationComponent)
